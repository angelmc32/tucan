  ...
  return (
    <div className="page text-center">
      <div className="md:max-w-sm">
        ...
        <p className="text-md mt-2 font-bold uppercase text-gray-700">Sign a message</p>
      ...
      <div className="md:max-w-sm">
        <p className="text-md mt-8 font-bold uppercase text-gray-700">Transfer ETH</p>
        <p className="mt-2 text-sm text-gray-600">
          Transfer Sepolia ETH from your embedded wallet. Enter a valid recipient address to enable
          the button.
        </p>
        <input
          type="text"
      ...
      <div className="md:max-w-sm">
        <p className="text-md mt-8 font-bold uppercase text-gray-700">Export your private key</p>
        <p className="mt-2 text-sm text-gray-600">
          Export your embedded wallet&apos;s private key to use in another wallet client.
        </p>
        <button
          type="button"
      ...
      <div className="md:max-w-sm">
        <p className="text-md mt-8 font-bold uppercase text-gray-700">Learn more</p>
        <p className="mt-2 text-sm text-gray-600">
          Read our{' '}
          <a
            className="underline"

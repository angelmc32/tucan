...
export default async function Home() {
  return (
    <div className="page items-center justify-center space-y-8 px-4 text-center md:space-y-6 md:px-8 md:!pt-40 lg:space-y-4 lg:!pt-32">
      <div>
        <h1 className={`${headerFont.className} text-center text-4xl text-[40px] md:text-5xl`}>
      ...
      <div className="lg:max-w-lg">
        <h3 className={`${headerFont.className} text-2xl sm:text-[2rem]`}>
          la plataforma para <span className="font-black text-destructive">builders</span> que

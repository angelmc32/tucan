...
const Dashboard = () => {
  ...
  return (
    <div className="page text-center">
      <div>
        <p className="text-md mt-2 font-bold uppercase text-gray-700">Your User Object</p>
      ...
      <div>
        <p className="text-md mt-8 font-bold uppercase text-gray-700">Account Linking</p>
        <p className="mt-2 text-sm text-gray-600">
